...
namespace RequestGenerator.Domain.SoftBank
{
    public class SoftBankRequestGeneratorManager : IRequestGeneratorManager
    {
        public RequestGenerationResult Process(CheckoutTransaction CheckoutTransaction)
        {
            string requestTemplate = BankResources.SoftBankRequestTemplate;
