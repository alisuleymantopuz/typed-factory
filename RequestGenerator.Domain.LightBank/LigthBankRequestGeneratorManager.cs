...
namespace RequestGenerator.Domain.LightBank
{
    public class LigthBankRequestGeneratorManager : IRequestGeneratorManager
    {
        public RequestGenerationResult Process(CheckoutTransaction CheckoutTransaction)
        {
            string requestTemplate = BankResources.LightBankRequestTemplate;
